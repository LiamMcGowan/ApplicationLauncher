...
namespace ApplicationLauncher
{
    ...
    public static class General
    {
        ...
        public static DataTable ReturnLookupValues(string tblName)
        {
            ...
            {
                case "lkpQROPSStatus":
                    query = "SELECT QROPSStatusID, StatusType, ImageName FROM lkpQROPSStatus WHERE EndDate Is NULL and StartDate <= GETDATE() ORDER BY StatusType ASC";
                    break;
                default:
                    break;
            }

...
namespace ApplicationLauncher
{
    class LoadAppVarables
    {
        ...
        public void LoadApplication()
        {
            ...
            #region Local FIle
            IniFile iniLocal = new IniFile(AppDomain.CurrentDomain.BaseDirectory + "lclAppLauncher.ini");
            GlobalFile = iniLocal.IniReadValue("Paths", "GlobalFile");
            if (File.Exists(AppDomain.CurrentDomain.BaseDirectory + "lclAppLauncher.ini"))
            {
                // Do nothing;
            }
            else
